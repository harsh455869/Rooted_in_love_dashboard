...
function CategoryList() {
    ...
    function getData(pageNumber=1){
        ...
        axios.get(`${config.serverURL}admin/product/getcategorynames`)
        .then((res)=>{
            ...
            <section>
                <div className="row">
                    ...
                    <div className="col-12">
                        ...
                        {modalOpened4 && <CategoryInfo addnew={isaddnew} categoryData={selectedBuyer}/>}
                    </Overlay>
                        </div>
                    </div>
                 <Sidebar/>
                    <div className="col-lg-11 col-10">
                        <div className="row upperhead">
                            ...
                            <div className="col-12" style={{textAlign:'right',display: 'block'}}>
                             <button type="button" className="btn btn-primary" style={{display: 'inline-block',margin:'unset',marginTop: '50px',marginRight: '30px',background: 'white',fontWeight: 600,color: '#254c86',border: 'solid 2px #254c86'}} onClick={()=>{setisaddnew(true);setmodalOpened4(true)}}>       New Category      </button>
                        </div>
                        </div>
                        <div className="row upperhead">
