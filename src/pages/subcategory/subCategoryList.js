...
function SubCategoryList() {
    ...
    function getData(pageNumber=1){
        ...
        axios.get(`${config.serverURL}admin/product/getsubcategorynames`)
        .then((res)=>{
            ...
            <section>
                <div className="row">
                    ...
                    <div className="col-12">
                        ...
                        {modalOpened4 && <SubCategoryInfo addnew={isaddnew} categoryData={selectedBuyer}/>}
                    </Overlay>
                        </div>
                    </div>
                 <Sidebar/>
                    <div className="col-lg-11 col-10">
                        <div className="row upperhead">
                            <div className="col-4">
                                <p className="invoice-tracker"><span className="invoice">Sub-Category</span> TRACKER</p>
